	...
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><a href="/" <?php echo $page_title=="WC English" ? "class='active'" : ""; ?> ><span>Home</span></a></li>
			<li role="separator" class="divider"></li>
			<li><a href="french" <?php echo $page_title=="WC French" ? "class='active'" : ""; ?> ><span>French</span></a></li>
			<li role="separator" class="divider"></li>
			<li><a href="spanish" <?php echo $page_title=="WC Spanish" ? "class='active'" : ""; ?> ><span>Spanish</span></a></li>
			<li role="separator" class="divider"></li>
			<li><a href="portuguese" <?php echo $page_title=="WC Portuguese" ? "class='active'" : ""; ?> ><span>Portuguese</span></a></li>
			<li role="separator" class="divider"></li>
			<li><a href="yoruba" <?php echo $page_title=="WC Yoruba" ? "class='active'" : ""; ?> ><span>Yoruba</span></a></li>
			<li role="separator" class="divider"></li>
			<li><a href="hausa" <?php echo $page_title=="WC Hausa" ? "class='active'" : ""; ?> ><span>Hausa</span></a></li>
			<li role="separator" class="divider"></li>
			<li><a href="igbo" <?php echo $page_title=="WC Igbo" ? "class='active'" : ""; ?> ><span>Igbo</span></a></li>
			<li role="separator" class="divider"></li>
