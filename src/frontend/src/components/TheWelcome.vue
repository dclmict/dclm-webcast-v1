  ...
  <div class="main-container">
   ...
   <div class="main-blogs">
        <div class="main-blog anim" style="--delay: .1s">
            <div class="myBigSlides animated fadeIn">
                <div class="imagediv">
                    <img class="imagedivContent" src="../assets/download.jpeg"/>
                    <div class="main-content">
                        <div class="main-blog__title">Gloroius Visitation From Christ</div>
                        <div class="main-blog__author">
                            <div class="author-img__wrapper">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                    <path d="M20 6L9 17l-5-5" />
                                </svg>
                                <img class="author-img" src="../assets/download.jpeg" />
                            </div>
            ...
            <div class="myBigSlides animated fadeIn">
                <div class="imagediv">
                    <img class="imagedivContent" src="../assets/download.jpeg"/>
                    <div class="main-content">
                        <div class="main-blog__title">New</div>
                        <div class="main-blog__author">
                            <div class="author-img__wrapper">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                    <path d="M20 6L9 17l-5-5" />
    ...
    <div class="mySlides animated fadeIn">
        <div class="main-blog" style="--delay: .2s">
            <img class="imagedivContent" src="../assets/images.jpeg"/>
            <div class="main-content-small">
                <div class="main-blog__title">Worship Days</div>
                <div class="main-blog__author tips">
                    ...
                    <div class="author-img__wrapper">
                        ...
                        <img class="author-img" src="../assets/images.jpeg" />
                    </div>
                    <div class="author-detail">
    ...
    <div class="mySlides animated fadeIn">
        <div class="main-blog" style="--delay: .2s">
            <img class="imagedivContent" src="../assets/biblestudy.jpeg"/>
            <div class="main-content-small">
                <div class="main-blog__title">Monday Bible Study</div>
                <div class="main-blog__author tips">
                    <div class="main-blog__time">7 min</div>
                    <div class="author-img__wrapper">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
    ...
    <div class="mySlides animated fadeIn">
        <div class="main-blog" style="--delay: .2s">
            <img class="imagedivContent" src="../assets/revival.jpeg"/>
            <div class="main-content-small">
                <div class="main-blog__title">Revival Hour</div>
                <div class="main-blog__author tips">
                    <div class="main-blog__time">7 min</div>
                    <div class="author-img__wrapper">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
...
<HelloWorld :vPage="videos"> </HelloWorld>
